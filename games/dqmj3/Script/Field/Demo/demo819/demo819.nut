...
// ▼リソース読込
	...
	LoadEffect_("ef732_22_star_seed_m_g");					// スターシード 軌道 緑
...
//-------------------------------------------------------------------------
	...
	Wait_(10);
	PlaySE_("SE_DEM_199");
	local task_starseed = Task_AnimeMoveNoFit_(starseed, "anm_starseed00");		//スターシード00
	WaitMotion(aroma);
	...
	local task_starseed = Task_AnimeMoveNoFit_(starseed, "anm_starseed01");		//スターシード01
