...
function Init()
{
	DebugPrint("BATTLE085_function_Init");
	BattleCommon_Init();
...
function Update()
{
	DebugPrint("BATTLE085_IN_function_Update")
	...
	DebugPrint("BATTLE085_OUT_function_Update")
	BatteleScript_End();
}
...
{
	DebugPrint("BATTLE085_function_SpellCast");
	local AllyFlag = IsAlly_(gAttack);
