...
function Init()
{
	DebugPrint("BATTLE008_function_Init");
	BattleCommon_Init();
...
function Update()
{
	DebugPrint("BATTLE008_function_Update");
...
function SAction()
{
	DebugPrint("BATTLE008_function_SAction");
	local WaitFrame = 15;
...
function MAction()
{
	DebugPrint("BATTLE008_function_MAction");
