...
function Init()
{
	DebugPrint("BATTLE010_function_Init");
	BattleCommon_Init();
...
function Update()
{
	DebugPrint("BATTLE010_function_Update");
...
function SAction()
{
	DebugPrint("BATTLE010_function_SAction");
...
function MAction()
{
	DebugPrint("BATTLE010_function_MAction");
	...
	if(cTarget.Size == SIZE_G){
		...
		Task_SetFrameAnimeMoveCamera_("camera_AttackMtoTargetSNM" , "camtgt_AttackMtoTargetSNM",StartFrame);
	}
